...
def send_quiz_email_to_students(student_emails, topic_name, duration, app):
    """
    app: the real Flask app instance (from current_app._get_current_object())
    """
    if app is None:
        raise ValueError("Flask app instance required for background email")
